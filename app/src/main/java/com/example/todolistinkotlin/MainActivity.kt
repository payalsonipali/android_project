...
class MainActivity : AppCompatActivity(), OnItemClick {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProvider(this, ToDoListViewModelFactory(this.application))
    ...
    override fun onItemClick(v: View, position: Int) {
        ...
        alert {
            ...
            positiveButton("Edit") {
                //called event tracker for edit
                val eventProperties = mapOf(
                    "action" to "Edit",
                    "user_id" to list.get(position).indexDb
                )
                analyticsTracker.trackEvent("EditToDoItem", eventProperties)
            ...
            negativeButton("Delete") {
                //called event tracker for delete
                val eventProperties = mapOf(
                    "action" to "Delete",
                    "user_id" to list.get(position).indexDb
                )
                analyticsTracker.trackEvent("DeleteToDoItem", eventProperties)
